...
const Product = (props) => {
    ...
    return (
        <div className="group bg-white rounded-2xl border border-slate-200/80 hover:border-amber-400 shadow-xs hover:shadow-xl transition-all duration-300 p-3.5 mx-1.5 flex flex-col justify-between relative overflow-hidden">
            
            {/* Top Bar: Category Chip & Wishlist Button */}
