...
const Product = (props) => {
    ...
    const whatsappMessage = encodeURIComponent(
        `👋 Hi Kaaviyaselvan, I want to order this product from Custom Hub:\n\n*${name}*\nPrice: ₹${price}\n\nPlease share details on payment and delivery!`
    );

    return (
        <div className="group bg-white rounded-2xl border border-slate-200 hover:border-sky-400 shadow-xs hover:shadow-xl transition-all duration-300 p-3.5 mx-1.5 flex flex-col justify-between relative overflow-hidden">
            
            {/* Top Bar: Sky Blue Category Chip & Wishlist Button */}
