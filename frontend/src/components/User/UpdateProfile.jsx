...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Update Profile | CustomHub Gift Shop" />
            ...
            <main className="w-full mt-12 sm:pt-20 sm:mt-0">
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="loginSidebar bg-primary-blue px-9 py-10 hidden sm:flex flex-col gap-4 w-2/5">
                        <h1 className="font-medium text-gray-800 text-3xl">Looks like you're new here!</h1>
                        <p className="text-gray-700 text-lg pr-2">Sign up with your mobile number to get started</p>
                    </div>
                    {/* <!-- sidebar column  --> */}
