...
const Login = () => {
    ...
    return (
        <>
            <MetaData title="Login | CustomHub Gift Shop" />
                ...
                <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <div className="text-center py-10 px-4 sm:px-14">
                            ...
                            <Link to="/register" className="font-medium text-sm text-primary-blue">New to CustomHub Gift Shop? Create an account</Link>
                        </div>
                        {/* <!-- edit info container --> */}
